...
import com.greymerk.editor.editor.shapes.RectWireframe;
...
public class ToolFillWireframe implements ITool {
	...
	public void onClick(IWorldEditor editor, Random rand, PlayerEntity player, ToolState state, Cardinal dir, Coord pos) {
		...
		state.fill(editor, rand, new RectWireframe(start, pos));
	}
}
